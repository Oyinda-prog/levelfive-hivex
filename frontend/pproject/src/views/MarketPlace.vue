...
<div class="d-flex flex-column p-3 gap-3 mt-2">
  ...
  <div class="col-12 d-none d-md-block col-md-1 offset-md-3">

  </div>
  <div class="col-12 col-md-5 mt-5">
 <div 
  class="col-12 shadow mb-4 mt-5 card z-n1"
...
<div class="col-3 ms-5">
    ...
    <!-- <span class="text-primary d-none d-sm-none d-md-block" >Liked</span>  -->
</div>
...
<div style="cursor: pointer;" @click="openmodal(post)" data-bs-toggle="modal" data-bs-target="#exampleModal">
         ...
         <!-- <span style="margin-left: 10px;" class="d-none d-sm-none d-md-block">comment</span> -->
     </div>
</div>
...
<div class="col-3">
   <div v-if="selectedpostimage.likes.find(like=>like.student_id == this.userid && like.status==1 )" @click="likebutton(selectedpostimage.id)" style="cursor: pointer;" >
    <img src="../assets/images/liketwo.jpeg" alt="" width="15px" height="15px">
    <!-- <span class="text-primary">Liked</span>  -->
</div>
...
<div v-if="this.replycheck===comment.id" class="my-5">
  ...
  <div  v-for="replies in comment.replies" :key="replies.id">
    ...
    <div class="col-2 col-xxl-auto col-auto col-sm-auto">
